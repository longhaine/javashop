...
<%
	JSONArray popularProduct = (JSONArray) request.getAttribute("popularProducts");
	int popularLength = popularProduct.length();
%>
    <!-- ##### Welcome Area Start ##### -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="popular-products-slides owl-carousel">
						...
						{
						JSONObject object = popularProduct.getJSONObject(i);
